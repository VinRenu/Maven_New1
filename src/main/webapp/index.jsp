...
<body>
  <div class="jumbotron" style="background-color:white">
     <h1 class="text-center">Welcome to</h1>
      ...
      <h2 class="text-center">WELL DONE - CONTINUES INTEGRATION - CI/CD Done - webhook -done - Git Polling-- -This page has been Updated Successfully - CI and CD compleated</h2>
  </div>
</body>
</html>
